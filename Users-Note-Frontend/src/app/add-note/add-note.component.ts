...
export class AddNoteComponent implements OnInit{
  ...
  this.errorMessage = '';
    ...
    this.http.post("https://harsh-backend.delightfulrock-1e48ae99.centralindia.azurecontainerapps.io/addNote", bodyData, { responseType: "text" }).subscribe((resultData: any) => {
