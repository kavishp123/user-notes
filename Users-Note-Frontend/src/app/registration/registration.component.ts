...
export class RegistrationComponent {
  ...
  onSubmit() {
    ...
    this.http.post("https://harsh-backend.delightfulrock-1e48ae99.centralindia.azurecontainerapps.io/register",bodyData,{responseType:"text"}).subscribe((resultData:any)=>{
